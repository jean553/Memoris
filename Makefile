Memoris: src/main.cpp
	...
	g++ bin/main.o bin/GameController.o bin/MainMenuController.o bin/NewGameController.o bin/EditorMainMenuController.o bin/Controller.o bin/ScreenFactory.o bin/MusicFactory.o bin/Context.o bin/InputTextWidget.o -o bin/Memoris -lsfml-graphics -lsfml-window -lsfml-system -lsfml-audio
