...
bin/EditorMenuController.o: src/editor_menu/EditorMenuController.cpp
	$(CC) $(CFLAGS) -c src/editor_menu/EditorMenuController.cpp -o bin/EditorMenuController.o

bin/EditorLevelController.o: src/editor_level/EditorLevelController.cpp
	$(CC) $(CFLAGS) -c src/editor_level/EditorLevelController.cpp -o bin/EditorLevelController.o
...
bin/Widget.o: src/widgets/Widget.cpp
	$(CC) $(CFLAGS) -c src/widgets/Widget.cpp -o bin/Widget.o
