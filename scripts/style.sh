...
astyle --options=config/astyle.conf src/utils/ControllerFactory.hpp
astyle --options=config/astyle.conf src/utils/ControllerFactory.cpp
...
astyle --options=config/astyle.conf src/widgets/CursorWidget.hpp
astyle --options=config/astyle.conf src/widgets/CursorWidget.cpp
astyle --options=config/astyle.conf src/widgets/InputTextWidget.hpp
